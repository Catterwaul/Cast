...
public struct CastError: Swift.Error {
  public init() { }
}

/// Like a throwing version of `as?`.
/// - Note: The return type can be inferred, which the various forms of `as` do not support.
/// - Bug: `Uncast` is used here, instead of `some Any`,
/// in preparation for a time when `CastError` can be generic.
public func cast<Uncast, Cast>(_ uncast: Uncast) throws(CastError) -> Cast {
